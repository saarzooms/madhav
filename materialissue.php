                  ...
                  <form method="post" action="#" id="project_form">
                     ...
                     <div class="panel panel-default" id="loanform">
                        <div class="panel-heading">
                           <div class="panel-title">Material Issue</div>
                          	  <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              <label class="control-label">Select Material For Database *</label>
                                              <input type="text" name="email" id="email" class="form-control" placeholder="Enter Category*" 	 	 											 	 	 										oninvalid="this.setCustomValidity('please enter name')" onchange="this.setCustomValidity('')" required>
                                           </div>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                    	<div class="col-md-4">
                                           <div class="form-group">
                                              <label class="control-label">Display UOM *</label>
                                              <input type="text" name="Designation" id="Designation" class="form-control" placeholder="Enter Display UOM*"	 	 	 										oninvalid="this.setCustomValidity('please enter name')" onchange="this.setCustomValidity('')" required>
                                           </div>
                                        </div>
                                    	<div class="col-md-4">
                                           <div class="form-group">
                                              <label class="control-label">Issued By *</label>
                                              <input type="email" name="email" id="email" class="form-control" placeholder="Enter Issued By*" 	 	 												 	 											oninvalid="this.setCustomValidity('please enter name')" onchange="this.setCustomValidity('')" required>
                                           </div>
                                        </div>
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              <label class="control-label">Issued To *</label>
                                              <input type="text" name="Designation" id="Designation" class="form-control" placeholder="Enter Issued To*"	 	 											oninvalid="this.setCustomValidity('please enter name')" onchange="this.setCustomValidity('')" required>
                                           </div>
                                        </div> 
                            		</div>
                                    ...
                                    <div class="col-md-12">
                                    	<div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="Designation" id="Designation" class="form-control" placeholder="Enter Issue To*"	 	 	 										oninvalid="this.setCustomValidity('please enter name')" onchange="this.setCustomValidity('')" required>
                                           </div>
                                        </div>
                                    	<div class="col-md-4">
                                           <div class="form-group">
                                              <label class="control-label">Returnable *</label></br>
                                              <input type="radio" name="" id="saf_inc" value="1"> Yes
											  <input type="radio" name="" id="saf_inc" value="0"> No
                                           </div>
                                        </div>
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              <label class="control-label">Consumable *</label></br>
                                              <input type="radio" name="" id="saf_inc" value="1"> Yes
											  <input type="radio" name="" id="saf_inc" value="0"> No
                                           </div>
                                        </div>  
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                           <div class="form-group">
                                          		<label for="user name">Scan Copy of Issue Slip *</label>
